...
buildTemplate(
  ...
  ['ชื่อหน้าตัด', 'น้ำหนัก (กก./เมตร)', 'ความยาวมาตรฐาน (เมตร)', 'กลุ่มหน้าตัด', 'รุ่น/ซีรีส์', 'ความหนา (มม.)'],
  ['เช่น หน้าตัด X', 'เช่น 1.0', 'เช่น 6.4 (เว้นว่างได้ ค่าเริ่มต้น 6.4)', 'เช่น กล่องร่อง (สำหรับผูกกับ BOM Template)', 'เช่น ทั่วไป, ยูโร, วิสดอม', 'เช่น 1.2'],
